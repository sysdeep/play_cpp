...
ImagesFrame::ImagesFrame(UIState *state, docker::DockerClient *docker_client) : state(state), docker_client{docker_client}
{
...
void ImagesFrame::process_update()
{
...
void ImagesFrame::start_update_task()
{
