...
ImageModel parser::parseImage(const std::string &src)
{
    ...
    ImageModel result{
        processString(document, "Id", "Error"), // Id
        processString(document, "Created", ""), // Created
        processUint64If(document, "Size", 0),   // Size
    };
...
ImageConfigModel parser::parseImageConfig(const rapidjson::Value &value)
{
    ...
    ImageConfigModel result{
        ...
        processStringsList(value, "Env"),        // Env
        processString(value, "StopSignal", ""),  // StopSignal
        processString(value, "User", ""),        // User
        processString(value, "WorkingDir", ""),  // WorkingDir
    };
